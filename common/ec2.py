...
category = {
    ...
    'frontend': ['web', 'cron', 'sentry', 'redislive', 'drawquest_web', 'drawquest_staging_web',
                 'drawquest_web_admin', 'drawquest_search'],
...
def get_role_size(role):
    return {
        ...
        'web': 'c1.medium',
        'drawquest_web': 'm1.small',
        'drawquest_web_admin': 'm1.medium',
        'drawquest_search': 'c1.medium',
        'testrunner': 'c1.medium',
        'drawquest_testrunner': 'c1.medium',
        'drawquest_staging_web': 'm1.small',
    }.get(role, 'm1.small')
