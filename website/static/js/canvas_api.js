...
canvas.api = {
     ...
     * items requested.
     * 
     * Can't specify both `later_than` and `earlier_than`.
     */
    activity_stream_items: function(optional_params) {
        var params = {};
        var args = arguments;
        $.each([], function(i, v) {
            params[v] = args[i];
     ...
     * 
     */
    feed_items: function(optional_params) {
        var params = {};
        var args = arguments;
        $.each([], function(i, v) {
            params[v] = args[i];
        ...
        this.data = params;
        return this._call('/api/feed/followee_comments', true, this.data);
    },
