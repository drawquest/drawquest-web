...
(function() {
  var Component, EraserStroke, MarkerStroke, PaintbrushStroke, PaintbucketStroke, PenStroke, Stroke, parse_playback_data, playback_data, playback_deferred, playback_drawing, _ref, _ref1, _ref2, _ref3, _ref4,
  ...
  PenStroke = (function(_super) {
    ...
    function PenStroke() {
      _ref = PenStroke.__super__.constructor.apply(this, arguments);
      return _ref;
    }
  ...
  MarkerStroke = (function(_super) {
    ...
    function MarkerStroke() {
      _ref1 = MarkerStroke.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
  ...
  PaintbrushStroke = (function(_super) {
    ...
    function PaintbrushStroke() {
      _ref2 = PaintbrushStroke.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
  ...
  EraserStroke = (function(_super) {
    ...
    function EraserStroke() {
      _ref3 = EraserStroke.__super__.constructor.apply(this, arguments);
      return _ref3;
    }
  ...
  PaintbucketStroke = (function(_super) {
    ...
    function PaintbucketStroke() {
      _ref4 = PaintbucketStroke.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
  ...
  */
  ...
  playback_drawing = function(playback_data, callback) {
    ...
    _ref5 = playback_data['strokes'];
    for (_i = 0, _len = _ref5.length; _i < _len; _i++) {
      stroke_data = _ref5[_i];
  ...
  parse_playback_data = function(data) {
    var _ref5;
    if ((data != null ? data.playback_data : void 0) != null) {
      data = JSON.parse(data.playback_data);
      if (!(data != null ? (_ref5 = data.strokes) != null ? _ref5.length : void 0 : void 0)) {
        return null;
      }
      return data;
    }
  ...
  window.begin_loading_playback_data = function(comment_id) {
    if (playback_deferred) {
      return;
    }
    return playback_deferred = dq.api("playback/playback_data", {
      comment_id: comment_id
    }).done(function(data) {
      return playback_data = parse_playback_data(data);
    });
  };

  window.begin_drawing_playback = function(comment_id, loaded_callback, animated_callback) {
    var loading_done;
