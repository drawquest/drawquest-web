...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Color.owned_by_default'
        db.add_column(u'palettes_color', 'owned_by_default',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Color.owned_by_default'
        db.delete_column(u'palettes_color', 'owned_by_default')
