...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ColorPack.sale_text'
        db.add_column(u'palettes_colorpack', 'sale_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ColorPack.sale_text'
        db.delete_column(u'palettes_colorpack', 'sale_text')
    ...
    models = {
        ...
        u'palettes.colorpack': {
            ...
            'ordinal': ('django.db.models.fields.IntegerField', [], {}),
            'owners': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['canvas_auth.User']", 'symmetrical': 'False'}),
            'sale_text': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'})
        }
    }
