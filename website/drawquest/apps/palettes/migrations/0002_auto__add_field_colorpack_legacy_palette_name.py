...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ColorPack.legacy_palette_name'
        db.add_column(u'palettes_colorpack', 'legacy_palette_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        # Adding M2M table for field colors on 'ColorPack'
        m2m_table_name = db.shorten_name(u'palettes_colorpack_colors')
        ...
        db.create_unique(m2m_table_name, ['colorpack_id', 'color_id'])


    def backwards(self, orm):
        # Deleting field 'ColorPack.legacy_palette_name'
        db.delete_column(u'palettes_colorpack', 'legacy_palette_name')

        # Removing M2M table for field colors on 'ColorPack'
        db.delete_table(db.shorten_name(u'palettes_colorpack_colors'))
    ...
    models = {
        ...
        u'palettes.colorpack': {
            ...
            'is_new': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'legacy_palette_name': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            'owners': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['canvas_auth.User']", 'symmetrical': 'False'})
        }
    }
