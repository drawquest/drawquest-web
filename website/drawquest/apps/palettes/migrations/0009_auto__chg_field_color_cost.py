...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Color.cost'
        db.alter_column(u'palettes_color', 'cost', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Color.cost'
        raise RuntimeError("Cannot reverse this migration. 'Color.cost' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Color.cost'
        db.alter_column(u'palettes_color', 'cost', self.gf('django.db.models.fields.IntegerField')())
