...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('quests_scheduledquest', 'quest', self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['canvas.Comment'], unique=True), keep_default=False)
