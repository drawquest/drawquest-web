...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Brush'
        db.create_table(u'brushes_brush', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ordinal', self.gf('django.db.models.fields.IntegerField')()),
            ('canonical_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ...
        db.send_create_signal(u'brushes', ['Brush'])

        # Adding M2M table for field owners on 'Brush'
        m2m_table_name = db.shorten_name(u'brushes_brush_owners')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('brush', models.ForeignKey(orm[u'brushes.brush'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['brush_id', 'user_id'])


    def backwards(self, orm):
        # Deleting model 'Brush'
        db.delete_table(u'brushes_brush')

        # Removing M2M table for field owners on 'Brush'
        db.delete_table(db.shorten_name(u'brushes_brush_owners'))
