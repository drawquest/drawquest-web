...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        brush = orm.Brush.objects.get(canonical_name='paint_bucket')
        brush.canonical_name = 'paintbucket'
        brush.iap_product_id = 'as.canv.drawquest.products.brushes.paintbucket'
        brush.save()
