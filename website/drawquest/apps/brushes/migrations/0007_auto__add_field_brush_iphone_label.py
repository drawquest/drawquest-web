...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Brush.iphone_label'
        db.add_column(u'brushes_brush', 'iphone_label',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Brush.iphone_label'
        db.delete_column(u'brushes_brush', 'iphone_label')
