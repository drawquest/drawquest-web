...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Brush.description'
        db.add_column(u'brushes_brush', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300, blank=True),
                      keep_default=False)

        # Adding field 'Brush.red'
        db.add_column(u'brushes_brush', 'red',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Brush.green'
        db.add_column(u'brushes_brush', 'green',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Brush.blue'
        db.add_column(u'brushes_brush', 'blue',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Brush.description'
        db.delete_column(u'brushes_brush', 'description')

        # Deleting field 'Brush.red'
        db.delete_column(u'brushes_brush', 'red')

        # Deleting field 'Brush.green'
        db.delete_column(u'brushes_brush', 'green')

        # Deleting field 'Brush.blue'
        db.delete_column(u'brushes_brush', 'blue')
