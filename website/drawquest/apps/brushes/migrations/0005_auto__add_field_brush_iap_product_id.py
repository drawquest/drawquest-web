...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Brush.iap_product_id'
        db.add_column(u'brushes_brush', 'iap_product_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Brush.iap_product_id'
        db.delete_column(u'brushes_brush', 'iap_product_id')
