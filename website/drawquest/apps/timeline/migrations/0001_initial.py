...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PendingTimelineShare'
        db.create_table('timeline_pendingtimelineshare', (
        ...
        db.send_create_signal('timeline', ['PendingTimelineShare'])


    def backwards(self, orm):
        # Deleting model 'PendingTimelineShare'
        db.delete_table('timeline_pendingtimelineshare')
