...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'PendingTimelineShare', fields ['comment']
        db.create_unique('timeline_pendingtimelineshare', ['comment_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PendingTimelineShare', fields ['comment']
        db.delete_unique('timeline_pendingtimelineshare', ['comment_id'])
    ...
    models = {
        ...
        'timeline.pendingtimelineshare': {
            'Meta': {'object_name': 'PendingTimelineShare'},
            'access_token': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'comment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['canvas.Comment']", 'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
