...
add_to_python_path('/var/canvas')
add_to_python_path('/var/canvas/common')

from configuration import Config, TESTING, PRODUCTION, LOCAL_SANDBOX, TESTING_BOX, STAGING, DRAWQUEST_ADMIN, DRAWQUEST_SEARCH
...
ALLOWED_HOSTS = ['.example.com', '.savnac.com', '.savn.ac', '.amazonaws.com', '.dqrouter1.com', 'drawquestapi1.com']
