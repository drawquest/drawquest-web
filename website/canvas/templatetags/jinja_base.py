...
env = Environment(loader=FileSystemLoader(template_dirs), autoescape=True, bytecode_cache=bytecode_cache,
                  ...
                  extensions=['jinja2.ext.i18n', ExtendsDjangoExtension, CsrfTokenExtension, CompressorExtension])

translations = Translations.load(django_settings.LOCALE_PATHS[0], django_settings.LOCALES)
