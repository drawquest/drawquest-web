...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserInfo.username_hash'
        db.alter_column(u'canvas_userinfo', 'username_hash', self.gf('django.db.models.fields.CharField')(max_length=40))

    def backwards(self, orm):

        # Changing field 'UserInfo.username_hash'
        db.alter_column(u'canvas_userinfo', 'username_hash', self.gf('django.db.models.fields.CharField')(max_length=30))
    ...
    models = {
        ...
        u'canvas.userinfo': {
            ...
            'username_hash': ('django.db.models.fields.CharField', [], {'max_length': '40'})
        },
