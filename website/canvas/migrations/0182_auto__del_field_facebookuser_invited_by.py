...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FacebookUser.invited_by'
        db.delete_column('canvas_facebookuser', 'invited_by_id')

        # Adding M2M table for field invited_by on 'FacebookUser'
        db.create_table('canvas_facebookuser_invited_by', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_facebookuser', models.ForeignKey(orm['canvas.facebookuser'], null=False)),
            ('to_facebookuser', models.ForeignKey(orm['canvas.facebookuser'], null=False))
        ))
        db.create_unique('canvas_facebookuser_invited_by', ['from_facebookuser_id', 'to_facebookuser_id'])


    def backwards(self, orm):
        # Adding field 'FacebookUser.invited_by'
        db.add_column('canvas_facebookuser', 'invited_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['canvas.FacebookUser'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field invited_by on 'FacebookUser'
        db.delete_table('canvas_facebookuser_invited_by')
    ...
    models = {
        ...
        'canvas.comment': {
            ...
            'attribution_user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
        ...
        'canvas.facebookuser': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invited_by': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['canvas.FacebookUser']", 'symmetrical': 'False', 'blank': 'True'}),
