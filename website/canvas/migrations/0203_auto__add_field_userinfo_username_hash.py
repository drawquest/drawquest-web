...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserInfo.username_hash'
        db.add_column(u'canvas_userinfo', 'username_hash',
                      self.gf('django.db.models.fields.CharField')(default='!', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserInfo.username_hash'
        db.delete_column(u'canvas_userinfo', 'username_hash')
    ...
    models = {
        ...
        u'canvas.userinfo': {
            ...
            'username_hash': ('django.db.models.fields.CharField', [], {'max_length': '30'})
        },
