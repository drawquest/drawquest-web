...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserInfo.email_hash'
        db.add_column(u'canvas_userinfo', 'email_hash',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserInfo.email_hash'
        db.delete_column(u'canvas_userinfo', 'email_hash')
