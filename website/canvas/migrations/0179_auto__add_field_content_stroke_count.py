...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Content.stroke_count'
        db.add_column('canvas_content', 'stroke_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Content.stroke_count'
        db.delete_column('canvas_content', 'stroke_count')
