...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Comment.parent_content'
        db.delete_column(u'canvas_comment', 'parent_content_id')


    def backwards(self, orm):
        # Adding field 'Comment.parent_content'
        db.add_column(u'canvas_comment', 'parent_content',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='comments', null=True, to=orm['canvas.Content'], blank=True),
                      keep_default=False)
