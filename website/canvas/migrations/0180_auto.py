...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Comment', fields ['star_count']
        db.create_index('canvas_comment', ['star_count'])


    def backwards(self, orm):
        # Removing index on 'Comment', fields ['star_count']
        db.delete_index('canvas_comment', ['star_count'])
