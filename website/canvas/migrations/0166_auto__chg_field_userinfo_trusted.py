...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserInfo.trusted'
        db.alter_column('canvas_userinfo', 'trusted', self.gf('django.db.models.fields.NullBooleanField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'UserInfo.trusted'
        db.alter_column('canvas_userinfo', 'trusted', self.gf('django.db.models.fields.BooleanField')())
