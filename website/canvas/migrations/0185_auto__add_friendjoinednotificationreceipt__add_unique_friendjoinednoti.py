...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FriendJoinedNotificationReceipt'
        db.create_table(u'canvas_friendjoinednotificationreceipt', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('actor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['auth.User'])),
            ('recipient', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['auth.User'])),
        ))
        db.send_create_signal(u'canvas', ['FriendJoinedNotificationReceipt'])

        # Adding unique constraint on 'FriendJoinedNotificationReceipt', fields ['actor', 'recipient']
        db.create_unique(u'canvas_friendjoinednotificationreceipt', ['actor_id', 'recipient_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'FriendJoinedNotificationReceipt', fields ['actor', 'recipient']
        db.delete_unique(u'canvas_friendjoinednotificationreceipt', ['actor_id', 'recipient_id'])

        # Deleting model 'FriendJoinedNotificationReceipt'
        db.delete_table(u'canvas_friendjoinednotificationreceipt')
    ...
    models = {
        ...
        u'canvas.bestof': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'best_of'", 'null': 'True', 'blank': 'True', 'to': u"orm['canvas.Category']"}),
            'chosen_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'comment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'best_of'", 'to': u"orm['canvas.Comment']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'canvas.externalcontent': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent_comment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'external_content'", 'to': u"orm['canvas.Comment']"}),
        ...
        u'canvas.invitecode': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invitee': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'invited_from'", 'null': 'True', 'blank': 'True', 'to': u"orm['auth.User']"}),
            'inviter': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'sent_invites'", 'null': 'True', 'blank': 'True', 'to': u"orm['auth.User']"})
        },
        u'canvas.remixplugin': {
