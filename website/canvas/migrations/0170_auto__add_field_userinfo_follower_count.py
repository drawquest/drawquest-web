...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserInfo.follower_count'
        db.add_column('canvas_userinfo', 'follower_count', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserInfo.follower_count'
        db.delete_column('canvas_userinfo', 'follower_count')
