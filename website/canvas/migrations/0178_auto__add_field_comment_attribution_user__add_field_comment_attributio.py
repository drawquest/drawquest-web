...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.attribution_user'
        db.add_column('canvas_comment', 'attribution_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Comment.attribution_copy'
        db.add_column('canvas_comment', 'attribution_copy',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.attribution_user'
        db.delete_column('canvas_comment', 'attribution_user_id')

        # Deleting field 'Comment.attribution_copy'
        db.delete_column('canvas_comment', 'attribution_copy')
