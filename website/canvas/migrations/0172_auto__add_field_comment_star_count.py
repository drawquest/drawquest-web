...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Comment.star_count'
        db.add_column('canvas_comment', 'star_count', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Comment.star_count'
        db.delete_column('canvas_comment', 'star_count')
