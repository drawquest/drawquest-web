...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('canvas_userinfo', 'trust_changed', self.gf('canvas.util.UnixTimestampField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserInfo.trust_changed'
        db.delete_column('canvas_userinfo', 'trust_changed')
