...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'canvas_remixplugin')

        # Deleting model 'BestOf'
        db.delete_table(u'canvas_bestof')

        # Deleting model 'InviteCode'
        db.delete_table(u'canvas_invitecode')

        # Adding field 'Comment.ugq'
        db.add_column(u'canvas_comment', 'ugq',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'canvas_remixplugin', (
            ('s3md5', self.gf('django.db.models.fields.CharField')(max_length=255)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('timestamp', self.gf('canvas.util.UnixTimestampField')(default=0)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'canvas', ['RemixPlugin'])

        # Adding model 'BestOf'
        db.create_table(u'canvas_bestof', (
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='best_of', null=True, to=orm['canvas.Category'], blank=True)),
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='best_of', to=orm['canvas.Comment'])),
        ...
        db.send_create_signal(u'canvas', ['BestOf'])

        # Adding model 'InviteCode'
        db.create_table(u'canvas_invitecode', (
            ('code', self.gf('django.db.models.fields.CharField')(max_length=32, unique=True)),
            ('inviter', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='sent_invites', null=True, to=orm['auth.User'], blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('invitee', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='invited_from', null=True, to=orm['auth.User'], blank=True)),
        ))
        db.send_create_signal(u'canvas', ['InviteCode'])

        # Deleting field 'Comment.ugq'
        db.delete_column(u'canvas_comment', 'ugq')
