...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.created_on_iphone'
        db.add_column(u'canvas_comment', 'created_on_iphone',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.created_on_iphone'
        db.delete_column(u'canvas_comment', 'created_on_iphone')
