...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Comment.skip_moderation'
        db.add_column('canvas_comment', 'skip_moderation', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Comment.skip_moderation'
        db.delete_column('canvas_comment', 'skip_moderation')
