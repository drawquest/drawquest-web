...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Comment', fields ['visibility']
        db.create_index('canvas_comment', ['visibility'])
    ...
    def backwards(self, orm):
        ...
        # Removing index on 'Comment', fields ['visibility']
        db.delete_index('canvas_comment', ['visibility'])
