...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserInfo.trusted'
        db.add_column('canvas_userinfo', 'trusted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserInfo.trusted'
        db.delete_column('canvas_userinfo', 'trusted')
