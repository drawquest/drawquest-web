...
class Metric(object):
    ...
    def record(self, request_or_user, **metadata):
        ...
        # Only disable parts unused for alarms.
    ...
    if settings.PROJECT == 'canvas':
        ...
        names = (
            ...
            ('misc', [
                ...
                ('share_to_twitter_from_publish', True, None),
                ('signup_from_canvas', None),

                ('receipt_verification_success', None),
            ...
            ('bad', [
                ...
                ('image_missing', None),
                ('facebook_signed_request_error', None),
                ('facebook_error_during_publish', None),
                ('twitter_error_during_publish', None),
                ('facebook_insufficient_permissions_during_publish', None),
                ('share_to_timeline_error', None),
                ('share_to_twitter_from_publish_error', None),
                ('star_error', None),
                ('receipt_verification_error', None),
            ]),
            ('email', [
                ('unsubscribe_email_address', None),
                ('unsubscribe_action', None),
